This text file describes the latest source code modifications made for time-evolving coronal simulations, detailed in the manuscript "H. P. Wang, S. Poedts, A. Lani, L. Linan, T. Baratashvili, F. Zhang, D. Sorokina, J. H.-J., Y. C. Li, N.-Z. Mahdi, and B. Schmieder. Time-evolving coronal modelling of solar maximum around the May 2024 storm by COCONUT. 2025.[arXiv:2505.11990]".

Several files across five directories—located within the "Plugins" and "src" folders—have been modified. These files are provided in the folder "DATA_DiskSection". Each directory contains all relevant files, including both modified and unmodified ones, along with a subfolder titled "Files Modified for Time-Evolving Simulations", which includes only the modified files and a corresponding "README" file.

For any questions or issues, please feel free to contact me at Haopeng.wang1@kuleuven.be.

Part 1. In the "src\Framework" folder, the following code files have been modified for time-evolving simulations.
...
Part 2. In the "Plugins\FiniteVolume" folder, the following code files have been modified for time-evolving simulations.
1. HLLFlux.cxx
Between Lines 96 and 119, Haopeng Wang  defined the parameter "alpha" for self-adjustable dispation term of HLL.
corresponding modifications are added between the comments started with "mark".

Part 3. In the "Plugins\FiniteVolumeMHD" folder, the following code files have been modified for time-evolving simulations.
...
Part 4. In the "Plugins\NewtonMethod" folder, the following code files have been modified for time-evolving simulations and enhanced numerical stability.
1. BDF2.cxx
...
Part 5. In the "Plugins\TecplotWriter" folder, the following code files have been modified for time-evolving simulations.
...
Part 6. In the "Plugins\MHD" folder, the following code files have been modified for time-evolving simulations and enhanced numerical stability.
1. MHD3DProjectionDiffVarSet.cxx 
Between Lines 112 and 147, plasma beta number has also been considered in translation between Spitzer form and collisionless form heating conduction terms. 
