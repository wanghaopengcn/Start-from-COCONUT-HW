...
#include "SuperInletProjectionParallel5.hh"
...
MethodCommandProvider<SuperInletProjectionParallel5, CellCenterFVMData, FiniteVolumeModule> 
superInletProjectionParallel5FVMCCProvider("SuperInletProjectionParallel5FVMCC");

//////////////////////////////////////////////////////////////////////////////

void SuperInletProjectionParallel5::defineConfigOptions(Config::OptionList& options)
{
...
SuperInletProjectionParallel5::SuperInletProjectionParallel5(const std::string& name) :
  SuperInlet(name),
  m_mapGeoToTrs(),
  m_mapTrs2Twall(),
  m_BfromFile(false)
...
SuperInletProjectionParallel5::~SuperInletProjectionParallel5()
{
}

//////////////////////////////////////////////////////////////////////////////

void SuperInletProjectionParallel5::setup()
{
  SuperInlet::setup();
...
void SuperInletProjectionParallel5::unsetup()
{
  SuperInlet::unsetup();
}
...
void SuperInletProjectionParallel5::setGhostState(GeometricEntity *const face)
{
  ...
  //idensityBoundary_dimless = 8.0;
  CFreal densityG_dimless = 2.*densityBoundary_dimless - (*innerState)[0];
  (*ghostState)[0] = densityG_dimless;
  //cout << "density at the boundary: " << densityBoundary_dimless << "prescribed: "<< densityG_dimless << endl;
  ...
  CFreal VBmag = 1935.07/(2.2e-4/sqrt(1.2566e-6*1.67e-13));
  ...
  // THIS IS ADDING TO PRESS

  //CFreal PressureBoundary_dimless = 0.0032549425343197064/(pow(BRef,2)/mu0)/0.759;
  CFreal PressureBoundary_dimless = _pBC; //0.108*8.0; //_pBC; // 0.108*8.0;
  // END ADDING TO PRESS
  //
