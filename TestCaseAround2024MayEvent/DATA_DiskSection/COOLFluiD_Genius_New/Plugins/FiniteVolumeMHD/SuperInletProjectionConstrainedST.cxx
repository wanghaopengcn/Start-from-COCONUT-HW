...
#include "SuperInletProjectionConstrainedST.hh"
...
MethodCommandProvider<SuperInletProjectionConstrainedST, CellCenterFVMData, FiniteVolumeModule> 
superInletProjectionConstrainedSTFVMCCProvider("SuperInletProjectionConstrainedSTFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SuperInletProjectionConstrainedST::defineConfigOptions(Config::OptionList& options)
{
...
SuperInletProjectionConstrainedST::SuperInletProjectionConstrainedST(const std::string& name) :
  SuperInlet(name),
  m_mapGeoToTrs(),
  m_mapTrs2Twall(),  // mark 2024.09.22
  m_BfromFile(false)
{
...
SuperInletProjectionConstrainedST::~SuperInletProjectionConstrainedST()
{
}

//////////////////////////////////////////////////////////////////////////////

void SuperInletProjectionConstrainedST::setup()
{
  SuperInlet::setup();
  ...
  // build the m_mapTrs2Twall storage mark 2024.09.22
...
void SuperInletProjectionConstrainedST::unsetup()
{
  SuperInlet::unsetup();
}


void SuperInletProjectionConstrainedST::setGhostState(GeometricEntity *const face)
{
...
// CFLog(INFO, "m_BfromFile[" << m_BfromFile << "], Br from File vs BrBoundary_dimless = " << BrFromFile << " ? " << BrBoundary_dimless << " \n"); 
  ...
  CFreal BxI_dimless = B_PFSS_dimless[0];
  CFreal ByI_dimless = B_PFSS_dimless[1];
  CFreal BzI_dimless = B_PFSS_dimless[2];
