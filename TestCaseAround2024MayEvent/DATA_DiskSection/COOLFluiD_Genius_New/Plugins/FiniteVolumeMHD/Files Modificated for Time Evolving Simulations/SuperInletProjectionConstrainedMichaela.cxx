...
#include "SuperInletProjectionConstrainedMichaela.hh"
...
MethodCommandProvider<SuperInletProjectionConstrainedMichaela, CellCenterFVMData, FiniteVolumeModule> 
superInletProjectionConstrainedMichaelaFVMCCProvider("SuperInletProjectionConstrainedMichaelaFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SuperInletProjectionConstrainedMichaela::defineConfigOptions(Config::OptionList& options)
{
...
SuperInletProjectionConstrainedMichaela::SuperInletProjectionConstrainedMichaela(const std::string& name) :
  SuperInlet(name),
  m_mapGeoToTrs(),
  m_mapTrs2Twall(),
  m_BfromFile(false)
...
SuperInletProjectionConstrainedMichaela::~SuperInletProjectionConstrainedMichaela()
{
}

//////////////////////////////////////////////////////////////////////////////

void SuperInletProjectionConstrainedMichaela::setup()
{
  SuperInlet::setup();
...
void SuperInletProjectionConstrainedMichaela::unsetup()
{
  SuperInlet::unsetup();
}
...
void SuperInletProjectionConstrainedMichaela::setGhostState(GeometricEntity *const face)
{
  ...
  if (m_initialSolutionMap.size() > 0) {
    ...
    for (CFuint i = 0; i < nbVars; ++i) {
      ...
      CFLog(DEBUG_MIN, "SuperInletProjectionConstrainedMichaela::setGhostState() => [" << varID << "] => " << (*initialValues)[idx] << " | " << (*innerState)[varID] << "\n");
    }
  }
  ...
  CFreal dist = (Vmag * vref - Vmagmax)/2e4;
  ...
  smooth_factor = 0.0;
  dist = (minPlasmaBeta - plasmaBeta)/0.002; //if current beta is 0.019, then dist is positive, smooth factor is close to 1
