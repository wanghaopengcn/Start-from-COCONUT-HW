#ifndef COOLFluiD_Numerics_FiniteVolume_SuperInletProjectionConstrainedMichaela_hh
#define COOLFluiD_Numerics_FiniteVolume_SuperInletProjectionConstrainedMichaela_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   *
   */
class SuperInletProjectionConstrainedMichaela : public SuperInlet {
public:
   ...
   * Constructor
   */
  SuperInletProjectionConstrainedMichaela(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~SuperInletProjectionConstrainedMichaela();
...
}; // end of class SuperInletProjectionConstrainedMichaela
...
#endif // COOLFluiD_Numerics_FiniteVolume_SuperInletProjectionConstrainedMichaela_hh
